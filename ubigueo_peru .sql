...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-04-2019 a las 18:40:27
...
INSERT INTO `alumnos` (`id`, `doc_identida`, `apellidos`, `nombres`, `telefono`, `direccion`, `idDepa`, `idProv`, `idDist`, `sexo`) VALUES
(2, '', 'RIVAS GUERRA', 'LUIS', '951242123', 'LAS FLORES', 2, 6, 3, 'M'),
(3, '', 'ROJAS REYES', 'SANDRA', '98723266', 'LOS PINOS', 9, 1, 5, 'F'),
(5, 'hgjjhgj', 'MELENDEZ LOSA', 'FELIPE', '2554599', 'LAS ORQUIDIAS', 2, 3, 2, 'M'),
(6, '', 'LEGUIA', 'LUCIA', '655656', 'PUNO', 14, 11, 7, 'F');
